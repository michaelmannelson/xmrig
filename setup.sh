...
#wget "https://github.com/michaelmannelson/xmrig/raw/main/xmrig-setup.sh"
#chmod +x "xmrig-setup.sh"
#sudo ./xmrig-setup.sh -o URL -u WALLET -p "`uname -o`.`uname -s`.`uname -n`.`uname -m`.$(date +"%Y%m%d@%H%M%S%z")"
